(function (j) {
    ...
    q.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            var e = this, g = 0, h, a = function (a) {
                ...
                }, i = a("xl/worksheets/sheet1.xml"), l = i.getElementsByTagName("sheetData")[0],
                a = {
                    ...
                    q = g + 1;
                    r = n(i, "row", {attr: {r: q}});
                    for (var b = 0, d = a.length; b < d - 1; b++) {
                        var e = x(b) + "" + q, f = null;
    ...
    q.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            for (var g = 0, h = d.body.length; g < h - 2; g++) e.push(j.map(d.body[g], function (a) {
                if (null === a || a === o) a = "";
